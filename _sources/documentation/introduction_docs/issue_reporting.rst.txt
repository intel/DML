...
The Intel® Data Mover Library (Intel® DML) library has several 
...
4. Check if the issue wasn't reported by the Intel DML team or other contributors. 
   Information about already known issues can be found in: 
   
   1. Release notes: `Known Issues <https://intel.github.io/DML/documentation/release_notes.html>`__ section. 
