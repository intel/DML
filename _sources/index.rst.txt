...
Intel DML is an open-source library that provides high-performance data manipulation on Intel CPUs.
Intel DML is intended for streaming data movement and transformation operations optimization
