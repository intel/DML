                                                                    ...
                                                                    ArgsT&&...           case_args)
{
    ...
    return register_benchmark_proxy(test_name, std::forward<CaseT>(case_functor), case_common_params_loc, data, std::forward<ArgsT>(case_args)...)->Apply(base_arguments<case_functor.exec_v>);
}
