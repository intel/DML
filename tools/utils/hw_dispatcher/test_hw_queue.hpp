...
#ifndef DML_TOOLS_UTILS_HW_DISPATCHER_TEST_HW_QUEUE_HPP_
#define DML_TOOLS_UTILS_HW_DISPATCHER_TEST_HW_QUEUE_HPP_
...
// DEFINITIONS
#define DML_TEST_TOTAL_OP_CFG_BIT_GROUPS 8U        /**< 256 bits / 32 bit groups */
#define DML_TEST_OWN_PAGE_MASK           0x0FFFLLU /**< Defines page mask for portal incrementing */
...
public:
    ...
    auto initialize_new_queue(descriptor_t* wq_descriptor_ptr) noexcept -> dml_test_hw_accelerator_status;
...
#endif //__linux__
#endif //DML_TOOLS_UTILS_HW_DISPATCHER_TEST_HW_QUEUE_HPP_
