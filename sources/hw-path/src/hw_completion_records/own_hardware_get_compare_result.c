...
/**
 * @brief Contains an implementation of the @ref dsa_get_compare_result function
 * @date 5/13/2020
 *
 */
#include <assert.h>
...
/**
 * @brief Represents a Completion Record of the @ref DML_OP_COMPARE and @ref DML_OP_COMPARE_PATTERN operations
 */
...
} own_compare_completion_record_t;
 ...
 */
static_assert(sizeof(own_compare_completion_record_t) == DSA_HW_COMPLETION_RECORD_SIZE,
...
{
    own_compare_completion_record_t *hw_result_ptr = (own_compare_completion_record_t *) completion_record_ptr;
