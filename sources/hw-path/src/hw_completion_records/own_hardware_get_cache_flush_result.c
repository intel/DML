...
/**
 * @brief Contains an implementation of the @ref dsa_get_cache_flush_result function
 * @date 5/26/2020
 *
 */
#include <assert.h>
...
} own_cache_flush_completion_record_t;
 ...
 */
static_assert(sizeof(own_cache_flush_completion_record_t) == DSA_HW_COMPLETION_RECORD_SIZE,
...
{
    own_cache_flush_completion_record_t *hw_result_ptr = (own_cache_flush_completion_record_t *) completion_record_ptr;
