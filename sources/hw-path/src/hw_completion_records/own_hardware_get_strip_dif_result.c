...
/**
 * @brief Contains an implementation of the @ref dsa_get_strip_dif_result function
 * @date 6/24/2020
 *
 */
#include <assert.h>
...
/**
 * @brief Represents a Completion Record of the @ref DML_OP_DIF_STRIP operation
 */
DML_HW_BYTE_PACKED_STRUCTURE_BEGIN
{
...
} own_strip_dif_completion_record_t;
DML_HW_BYTE_PACKED_STRUCTURE_END
 ...
 */
static_assert(sizeof(own_strip_dif_completion_record_t) == DSA_HW_COMPLETION_RECORD_SIZE,
...
{
    own_strip_dif_completion_record_t *hw_result_ptr = (own_strip_dif_completion_record_t *) completion_record_ptr;
