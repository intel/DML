...
/**
 * @brief Contains an implementation of the @ref dsa_get_dualcast_result function
 * @date 5/20/2020
 *
 */
#include <assert.h>
...
/**
 * @brief Represents a Completion Record of @ref DML_OP_DUALCAST operation
 */
...
} own_dualcast_completion_record_t;
 ...
 */
static_assert(sizeof(own_dualcast_completion_record_t) == DSA_HW_COMPLETION_RECORD_SIZE,
...
{
    own_dualcast_completion_record_t *hw_result_ptr = (own_dualcast_completion_record_t *) completion_record_ptr;
    ...
    switch (hw_status)
    {
        ...
        case HW_STATUS_DUALCAST_MISALIGN_ERROR:
