...
namespace dml
{
    ...
    struct mem_move_result
    {
        ...
        result_t    result{};                   /**< Copy direction: 0 - Forward, 1 - Backward. */
    };
    ...
    /**
     * @brief Result for @ref compare_operation and @ref compare_pattern_operation
     */
    struct compare_result
    {
        status_code status{status_code::error}; /**< Status of operation execution */
        result_t    result{};                   /**< Comparison result: 0 - Equal, 1 - Not equal */
    ...
    /**
     * @brief Result for @ref crc_operation and @ref copy_crc_operation
     */
    struct crc_result
    {
        status_code status{status_code::error}; /**< Status of operation execution */
