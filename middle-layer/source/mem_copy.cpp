...
namespace dml::ml
{
    DML_PACKED_STRUCT_DECLARATION_BEGIN(mem_copy_descriptor)
    {
    ...
    DML_PACKED_STRUCT_DECLARATION_BEGIN(mem_copy_completion_record)
    {
    ...
    mem_copy::mem_copy(const byte_t *src, byte_t *dst, size_t size) noexcept: operation_()
    {
        auto &descriptor = *reinterpret_cast<mem_copy_descriptor *>(operation_.data());
    ...
    void mem_copy::operator()() const noexcept
    {
        auto dsc    = reinterpret_cast<const mem_copy_descriptor *>(operation_.data());
        auto record = reinterpret_cast<mem_copy_completion_record *>(dsc->completion_record_ptr);
    ...
    result::operator mem_copy_result() const noexcept
    {
        auto record = reinterpret_cast<const mem_copy_completion_record *>(data_);
