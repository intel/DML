...
/**
 * @date 05/19/2021
 * @brief Contains definitions of @ref dml::ml::crc type
 */

#ifndef DML_ML_CRC_HPP
#define DML_ML_CRC_HPP
...
namespace dml::ml
{
    ...
    public:
        /**
         * @brief Initializes underlying operation with CRC operation
         *
         ...
         */
        crc(const byte_t *src, size_t size, uint32_t crc_seed, crc_parameters parameters) noexcept;

        /**
         * @brief Executes as CRC operation
         */
