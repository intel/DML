...
/**
 * @date 05/19/2021
 * @brief Contains definitions of @ref dml::ml::mem_copy type
 */

#ifndef DML_ML_MEM_COPY_HPP
#define DML_ML_MEM_COPY_HPP
...
namespace dml::ml
{
    ...
    public:
        /**
         * @brief Initializes underlying operation with Memory Copy operation
         *
         ...
         */
        mem_copy(const byte_t *src, byte_t *dst, size_t size) noexcept;

        /**
         * @brief Executes as Memory Copy operation
         */
