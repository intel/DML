...
/**
 * @date 05/19/2021
 * @brief Contains definitions of @ref dml::ml::cache_flush type
 */

#ifndef DML_ML_CACHE_FLUSH_HPP
#define DML_ML_CACHE_FLUSH_HPP
...
namespace dml::ml
{
    ...
    public:
         ...
         * @param invalidate  Enable cache invalidation
         */
        cache_flush(byte_t *dst, size_t size, bool invalidate) noexcept;

        /**
         * @brief Executes as Cache Flush operation
         */
